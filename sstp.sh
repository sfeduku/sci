...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/sfeduku/sci/main/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/sfeduku/sci/main/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/sfeduku/sci/main/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/sfeduku/sci/main/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/xp-sstp https://raw.githubusercontent.com/sfeduku/sci/main/xp-sstp.sh && chmod +x /usr/bin/xp-sstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/sfeduku/sci/main/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
